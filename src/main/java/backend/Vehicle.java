...
public class Vehicle {
    ...
    public Vehicle(String make, String brand, String year, String miliage, String color, double prices, String typeCar, String warrantyTime, String accidentHistory) {
        this.make = make;
        this.brand = brand;
        this.year = year;
